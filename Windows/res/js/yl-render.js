YL.render = function (data) {
  ...
  $(window).on("message", function (e) {
    ...
    if ($.inArray(data.type, ["ylui-pong", "ylui-eval", "ylui-emit"]) < 0) {
      return;
    }
    var from = data.from;
    var id = from[0];
            ...
            window.frames[t].postMessage(
              {
                ...
                from: id,
                sameOrigin:
                  parsedFrom.protocol === parsedTo.protocol &&
                  parsedFrom.host === parsedTo.host &&
                  parsedFrom.port === parsedTo.port,
              },
              "*"
            );
        });
    ...
    methods: {
      contextMenuAddTo: function (objCopy) {
        ...
        return [
          ...
          [
            [
              YL.util.getStrFa("desktop") + YL.lang("DesktopIcons"),
              function () {
            ...
            [
              YL.util.getStrFa("list-ul") + YL.lang("MainMenu"),
              function () {
            ...
            [
              YL.util.getStrFa("sliders") + YL.lang("Sidebar"),
              function () {
      ...
      contextMenuUninstall: function (appId) {
        ...
        return [
          ...
          function (v) {
            YL.util.simpleConfirm(
              Yuri2.template(
                YL.lang("UninstallConfirm"),
                that.apps[appId].title
              ),
              function () {
          ...
          [
            [
              ...
              function (v) {
                that.appOpen(
                  obj.app,
                  Yuri2.jsonMerge(obj, { openMode: "normal" }),
                  obj
                );
              },
            ],
            [
              ...
              function (v) {
                that.appOpen(
                  obj.app,
                  Yuri2.jsonMerge(obj, { openMode: "max" }),
                  obj
                );
              },
            ],
            [
              ...
              function (v) {
                that.appOpen(
                  obj.app,
                  Yuri2.jsonMerge(obj, { openMode: "min" }),
                  obj
                );
              },
            ],
            [
              ...
              function (v) {
                that.appOpen(
                  obj.app,
                  Yuri2.jsonMerge(obj, { openMode: "outer" }),
                  obj
                );
              },
            ],
      ...
      onResize: function () {
        ...
        that.runtime.startMenu.width =
          clientSize.width > that.startMenu.width && !that.runtime.isSmallScreen
            ? that.startMenu.width
            : clientSize.width;
        that.runtime.startMenu.height =
          that.runtime.desktopSize.height > that.startMenu.height &&
          !that.runtime.isSmallScreen
        ...
        var widthFixed =
          that.runtime.startMenu.width -
          (that.runtime.isSmallScreen ? 80 : 328);
        var groupNum = 1; //多少列
        if (widthFixed <= 460) {
          groupNum = 1;
        ...
        that.runtime.shortcutsGrid.x = parseInt(
          that.runtime.desktopSize.width / that.runtime.shortcutWidth
        );
        that.runtime.shortcutsGrid.y = parseInt(
          that.runtime.desktopSize.height / that.runtime.shortcutHeight
        );
      ...
      initRuntime: function (first) {
        ...
        if (Yuri2.isIE()) {
          ...
          if (YL.static.WarningPerformanceInIE) {
            setTimeout(function () {
              YL.msg(
                YL.lang("WarningPerformanceInIETitle"),
                YL.lang("WarningPerformanceInIEContent")
              );
            }, 2000);
          }
        }
        ...
        if (first && !YL.static.serialNumber) {
          YL.onReady(function () {
            setTimeout(function () {
              YL.msg(
                ";argefan's Windows",
                "Hello，你好，欢迎来到 Windows 小分站！<br/>个人主页：" +
                  '<a style="color: white" target="_blank" href="https://largefan.github.io/">https://largefan.github.io/</a><br />本网站 UI 由 ' +
                  '<a style="color: white" target="_blank" href="https://ylui.yuri2.cn"> YLUI </a> 强力驱动<p>欢迎使用支付宝扫描二维码对作者进行捐赠~<br/><br/><img style="width: 100%" src="https://cdn.jsdelivr.net/gh/zhaoze-jpg/Xianqi@main/img/reward/alipay.jpg"/></p>'
              );
            }, 1500);
          });
        }
      ...
      setWithID: function (obj, val, prefix, ran) {
        ...
        do {
          var id =
            ran === true
              ? prefix + Yuri2.randInt(100000000, 999999999)
              : prefix + YL.util.getID();
      ...
      appOpen: function (id, options, source) {
        ...
        if (this.runtime.winOpened >= this.configs.openMax) {
          YL.util.simpleMsg(
            Yuri2.template(YL.lang("MaxWinsReached"), this.configs.openMax)
          );
          return;
        }
        ...
        var dx =
          parseInt(this.runtime.winOpenCounter % 10) *
          this.runtime.clientSize.height *
          0.01; //坐标偏移量
        ...
        var evalNum = function (str) {
          ...
          if (isNaN(str)) {
            try {
              ...
              var query =
                "var x=YL.vue.runtime.clientSize.width;var y=YL.vue.runtime.clientSize.height-40;" +
                str;
              rel = eval(query);
            } catch (e) {
              YL.debug(e);
        ...
        var win = {
          ...
          style: {
            ...
            position: {
              ...
              y:
                evalNum(app.position.y) +
                (app.position.autoOffset ? dx + 80 : 0),
        ...
        that.$nextTick(function () {
          ...
          YL.util.iframeOnClick.track(
            ifr,
            function () {
              if (
                Object.getOwnPropertyNames(YL.util._iframe_click_lock_children)
                  .length === 0
              ) {
      ...
      winMaximize: function (id) {
        ...
        win.style.size.height =
          this.runtime.desktopSize.height - (win.addressBar ? 80 : 40);
      },
      ...
      winTitleMouseDown: function (id, e) {
        ...
        var fnMouseMove = function (e) {
          ...
          win.style.position.x += win.style.position.left
            ? x - win.drag.x
            : win.drag.x - x;
          win.style.position.y += win.style.position.top
            ? y - win.drag.y
            : win.drag.y - y;
          win.drag.x = x;
          win.drag.y = y;
      ...
      winResizeMouseDown: function (id, e) {
        ...
        var fnMouseMove = function (e) {
          ...
          win.style.size.height > minHeight ||
            (win.style.size.height = minHeight);
          win.drag.x = x;
          win.drag.y = y;
        };
      ...
      winStyle: function (id) {
        ...
        return {
          ...
          bottom: !win.style.position.top
            ? win.style.position.y + "px"
            : "auto",
          right: !win.style.position.left
            ? win.style.position.x + "px"
            : "auto",
      ...
      winRefresh: function (id) {
        ...
        this.winJump(
          id,
          win.urlRandomToken ? YL.util.updateUrlRandomToken(target) : target
        );
      },
      winHome: function (id) {
        var win = this.wins[id];
      ...
      winContextMenu: function (id, e) {
        ...
        var menu = [
          [
            YL.util.getStrFa("refresh") + YL.lang("Refresh"),
            function () {
              that.winRefresh(id);
            },
          ],
        ...
        if (!win.addressBar) {
          menu.push([
            YL.util.getStrFa("location-arrow") + YL.lang("DisplayAddressBar"),
            function () {
              win.addressBar = true;
            },
          ]);
          ...
          menu.push([
            YL.util.getStrFa("location-arrow") + YL.lang("HideAddressBar"),
            function () {
        ...
        menu.push([
          YL.util.getStrFa("magic") + YL.lang("CollectAsApplication"),
          function () {
            layer.prompt(
              {
        ...
        var menuWin = [];
        menuWin.push(
          YL.util.getStrFa("arrows") +
            Yuri2.template(
              "${0}px * ${1}px",
              parseInt(win.style.size.width),
              parseInt(win.style.size.height)
            )
        );
        menuWin.push([
          YL.util.getStrFa("window-restore") + YL.lang("CentreAdjustment"),
          function () {
        ...
        if (that.winIsMin(id)) {
          menuWin.push([
            YL.util.getStrFa("clone") + YL.lang("DisplayWindow"),
            function () {
              that.winShow(id);
            },
          ]);
        ...
        if (win.style.position.left) {
          menuWin.push([
            YL.util.getStrFa("angle-double-right") +
              YL.lang("AlignRight") +
              Yuri2.template(" (${0}px)", parseInt(win.style.position.x)),
            function () {
          ...
          menuWin.push([
            YL.util.getStrFa("angle-double-left") +
              YL.lang("AlignLeft") +
              Yuri2.template(" (${0}px)", parseInt(win.style.position.x)),
            function () {
              win.style.position.left = !win.style.position.left;
        ...
        if (win.style.position.top) {
          menuWin.push([
            YL.util.getStrFa("angle-double-down") +
              YL.lang("AlignBottom") +
              Yuri2.template(" (${0}px)", parseInt(win.style.position.y)),
            function () {
          ...
          menuWin.push([
            YL.util.getStrFa("angle-double-up") +
              YL.lang("AlignTop") +
              Yuri2.template(" (${0}px)", parseInt(win.style.position.y)),
            function () {
              win.style.position.top = !win.style.position.top;
        ...
        menu.push([
          YL.util.getStrFa("windows") + YL.lang("WindowPosition"),
          menuWin,
        ]);
        menu.push([
          YL.util.getStrFa("paper-plane") + YL.lang("OpenOuter"),
          function () {
            window.open(win.url);
          },
        ]);
        ...
        if (win.source) {
          menu.push([
            YL.util.getStrFa("crop") + YL.lang("RememberSizeAndPosition"),
            function () {
              win.source.style = {};
          ...
          if (win.source.style) {
            menu.push([
              YL.util.getStrFa("crop") + YL.lang("ResetSizeAndPosition"),
              function () {
        ...
        if (win.plugin) {
          ...
          if (win.background) {
            menu.push([
              YL.util.getStrFa("sort-up") + YL.lang("PutForeground"),
              function () {
            ...
            menu.push([
              YL.util.getStrFa("sort-down") + YL.lang("PutBackground"),
              function () {
                win.background = true;
              },
            ]);
      ...
      desktopMouseDown: function (e) {
        this.hideOpens();
        !e ||
          this.emitWinEvent(0, "desktopMouseDown", {
            x: e.x,
            y: e.y,
          });
      },
      ...
      desktopClick: function (e) {
        this.hideOpens();
        !e ||
          this.emitWinEvent(0, "desktopClick", {
            x: e.x,
            y: e.y,
          });
      },
      desktopContextMenu: function (e) {
        ...
        var menu = [
          ...
          "|",
          [
            YL.util.getStrFa("desktop") + YL.lang("DisplayDesktop"),
            function () {
              that.showDesktop();
            },
          ],
          [
            ...
            [
              [
                YL.util.getStrFa("paint-brush") + YL.lang("ThemeColor"),
                function () {
              ...
              [
                YL.util.getStrFa("picture-o") + YL.lang("Wallpaper"),
                function () {
          ...
          [
            YL.util.getStrFa("cog") + YL.lang("SystemOptions"),
            function () {
              YL.open("yl-system");
            },
            !YL.static.changeable,
          ...
          "|",
          [
            YL.util.getStrFa("object-group") + YL.lang("FullScreen"),
            function () {
              YL.util.enableFullScreen();
            },
          ],
          [
            YL.util.getStrFa("object-ungroup") + YL.lang("NormalScreen"),
            function () {
              YL.util.disableFullScreen();
            },
          ],
          [
            YL.util.getStrFa("circle-o-notch") + YL.lang("Reload"),
            function () {
              YL.f5();
            },
          ],
          "|",
          [
            YL.util.getStrFa("info-circle") + YL.lang("AboutUs"),
            function () {
              YL.aboutUs();
            },
          ],
      ...
      shortcutOpen: function (s, id) {
        ...
        if (
          !s ||
          s.drag.moved > 20 ||
          now - this.runtime.shortcutOpenedAt < 500
        ) {
      ...
      shortcutPosition: function (id, pid) {
        ...
        var s =
          pid === null ? this.shortcuts[id] : this.shortcuts[pid].children[id];
        return {
      ...
      shortcutMouseDown: function (id, pid, e) {
        ...
        var s = !isFromDrawer
          ? that.shortcuts[id]
          : that.shortcuts[pid].children[id];
        s.drag.mDown = true;
        s.drag.x = point.x;
        s.drag.y = point.y;
        s.drag.moved = 0;
        var fnDragOn = function (index) {
          ...
          that.shortcuts.forEach(function (t, i) {
            ...
            var by = pt.y - p.y;
            if (
              Math.abs(bx) < that.runtime.shortcutWidth / 4 &&
        ...
        var fnMouseMove = function (e) {
          ...
          else that.runtime.shortcutInsert = null;

          if (dragTo.over)
            //拖动覆盖的视觉提示
            that.runtime.shortcutOver = dragTo.id;
          else that.runtime.shortcutOver = null;
        };
        if (isMouse) {
          $(document).mouseup(fnMouseUp);
          $(document).mousemove(fnMouseMove);
      ...
      shortcutCutOutFromDrawer: function (s) {
        return (
          Math.abs(s.drag.left) + Math.abs(s.drag.top) >
          1.5 * this.runtime.shortcutWidth
        );
      },
      shortcutContextMenu: function (id, pid, e, isDrawer) {
        var that = this;
        var s =
          pid === null ? that.shortcuts[id] : that.shortcuts[pid].children[id];
        var menu = [];
        if (s.children) {
          menu.push([
            YL.util.getStrFa("play-circle") + YL.lang("Open"),
        ...
        if (s.app && that.apps[s.app].badge) {
          menu.push([
            YL.util.getStrFa("map-pin") + YL.lang("ClearSuperscript"),
            function () {
        ...
        menu.push([
          ...
          function (v) {
            YL.util.simpleConfirm(
              Yuri2.template(YL.lang("DeleteIconConfirm"), s.title),
              function () {
                if (isDrawer) {
                  that.shortcuts[pid].children.splice(id, 1);
                } else {
      ...
      barContextMenu: function (e) {
        ...
        var menu = [
          [
            YL.util.getStrFa("window-minimize") + YL.lang("HideAll"),
            function () {
              that.winHideAll();
            },
          ],
          [
            YL.util.getStrFa("clone") + YL.lang("DisplayAll"),
            function () {
              that.winShowAll();
            },
          ],
          [
            YL.util.getStrFa("window-close") + YL.lang("CloseAll"),
            function () {
              that.winCloseAll();
            },
          ],
      ...
      tileContextMenu: function (groupIndex, tileIndex, e) {
        ...
        var menu = [
          ...
          "|",
          [
            YL.util.getStrFa("braille") + YL.lang("Small") + YL.lang("Size"),
            function () {
              tile.w = 1;
              tile.h = 1;
            },
          ...
          [
            YL.util.getStrFa("braille") + YL.lang("Middle") + YL.lang("Size"),
            function () {
              tile.w = 2;
              tile.h = 2;
            },
          ...
          [
            YL.util.getStrFa("braille") + YL.lang("Big") + YL.lang("Size"),
            function () {
              tile.w = 4;
              tile.h = 4;
            },
        ...
        menu.push([
          ...
          function () {
            YL.util.simpleConfirm(
              Yuri2.template(YL.lang("DeleteTileConfirm"), tile.title),
              function () {
                that.tiles[groupIndex].data.splice(tileIndex, 1);
              }
            );
      ...
      tileSrcCustom: function (app) {
        return app.urlRandomToken
          ? YL.util.updateUrlRandomToken(
              app.customTile,
              "",
              this.runtime.customTileRandomToken
            )
          : app.customTile;
      },
      menuContextMenu: function (data) {
          ...
          menu.push([
            ...
            function () {
              ...
              that.menuItemAction(cut, function (child, father) {
                if (father.children) that.$delete(father.children, cut);
                else that.$delete(father, cut);
        ...
        menu.push([
          ...
          function () {
            //递归删除依赖菜单
            YL.util.simpleConfirm(
              Yuri2.template(YL.lang("DeleteMenuConfirm"), item.title),
              function () {
                that.menuItemAction(itemId, function (child, father) {
                  if (father.children) that.$delete(father.children, itemId);
                  else that.$delete(father, itemId);
                });
              }
            );
          },
      ...
      backgroundToThemeColor: function () {
        var that = this;
        YL.util.imgUrlToThemeColor(
          this.runtime.wallpaper,
          function (color) {
      ...
      sidebarBtnContextMenu: function (i, e) {
        ...
        var menu = [
          ...
          [
            ...
            function () {
              YL.util.simpleConfirm(
                Yuri2.template(YL.lang("DeleteBtnConfirm"), btn.title),
                function () {
      ...
      tilesTitleContextMenu: function (groupIndex, e) {
        ...
        var menu = [
          ...
          [
            ...
            function () {
              YL.util.simpleConfirm(
                Yuri2.template(YL.lang("DeleteGroupConfirm"), group.title),
                function () {
      ...
      startMenuResizeMouseDown: function (e) {
        ...
        var fnMouseMove = function (e) {
          ...
          that.startMenu.height -=
            (that.configs.topTaskBar ? -1 : 1) * (y - startMenu.drag.y);
          that.startMenu.height > minHeight ||
            (that.startMenu.height = minHeight);
          startMenu.drag.x = x;
          startMenu.drag.y = y;
          that.onResize();
